class Solution {
    public List<List<String>> groupAnagrams(String[] strs) {
        ...
        for (String elem : strs) {
            ...
            if (!listVector.containsKey(tempStr)) {
                // 2. If not, create a new list and put it in the map
                listVector.put(tempStr, new ArrayList<String>());
            }

            listVector.get(tempStr).add(elem);
        }
